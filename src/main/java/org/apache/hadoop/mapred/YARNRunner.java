...
public class YARNRunner implements ClientProtocol {
  ...
  /**
   * Similar to {@link org.apache.hadoop.mapred.YARNRunner#YARNRunner(Configuration, ResourceMgrDelegate)}
  ...
  @Override
  public org.apache.hadoop.mapreduce.JobStatus submitJob(org.apache.hadoop.mapreduce.JobID jobId, String jobSubmitDir, Credentials ts)
          throws IOException, InterruptedException {
  ...
  public ApplicationSubmissionContext createApplicationSubmissionContext(
    ...
    if (jobConf.get(MRJobConfig.JAR) != null) {
      ...
      String pattern = conf.getPattern(org.apache.hadoop.mapreduce.JobContext.JAR_UNPACK_PATTERN,
    ...
    appContext.setQueue(                                       // Queue name
            jobConf.get(org.apache.hadoop.mapreduce.JobContext.QUEUE_NAME,
  ...
  @Override
  public void setJobPriority(org.apache.hadoop.mapreduce.JobID arg0, String arg1) throws IOException,
          InterruptedException {
  ...
  @Override
  public Counters getJobCounters(org.apache.hadoop.mapreduce.JobID arg0) throws IOException,
          InterruptedException {
  ...
  public org.apache.hadoop.mapreduce.JobStatus getJobStatus(org.apache.hadoop.mapreduce.JobID jobID) throws IOException,
          InterruptedException {
    org.apache.hadoop.mapreduce.JobStatus status = clientCache.getClient(jobID).getJobStatus(jobID);
    return status;
  }

  @Override
  public TaskCompletionEvent[] getTaskCompletionEvents(org.apache.hadoop.mapreduce.JobID arg0, int arg1,
                                                       int arg2) throws IOException, InterruptedException {
    return clientCache.getClient(arg0).getTaskCompletionEvents(arg0, arg1, arg2);
  }

  @Override
  public String[] getTaskDiagnostics(org.apache.hadoop.mapreduce.TaskAttemptID arg0) throws IOException,
          InterruptedException {
    return clientCache.getClient(arg0.getJobID()).getTaskDiagnostics(arg0);
  }

  @Override
  public TaskReport[] getTaskReports(org.apache.hadoop.mapreduce.JobID jobID, TaskType taskType)
          throws IOException, InterruptedException {
  ...
  public void killJob(org.apache.hadoop.mapreduce.JobID arg0) throws IOException, InterruptedException {
    ...
    org.apache.hadoop.mapreduce.JobStatus status = clientCache.getClient(arg0).getJobStatus(arg0);
    if (status.getState() != org.apache.hadoop.mapreduce.JobStatus.State.RUNNING) {
      try {
  ...
  @Override
  public boolean killTask(org.apache.hadoop.mapreduce.TaskAttemptID arg0, boolean arg1) throws IOException,
          InterruptedException {
